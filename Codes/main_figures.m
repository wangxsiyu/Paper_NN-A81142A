...
pip.pip_addstep_folder_sfx_all(tid_1D, 'FIGURE_1D_model', {sub, 'variable5', true}, ...
    ...
    'is_output', true);
tid_1D = W_lp_sfx.next_sfx_ID;
W_lp_sfx.set_sfx({'t0t1000_svmp_midRT_nstd_scaledEVloc_npool1'});
pip.pip_addstep_folder_sfx_all(tid_1D, 'FIGURE_1D_model', {sub, 'variable5', true}, ...
    {'model1D_autosfx'}, [4,1,2,3], 'outputnames', 'FigureS9', 'jobname', '1D model', ...
    'is_output', true);
tid_1D = W_lp_sfx.next_sfx_ID;
W_lp_sfx.set_sfx({'t0t1000_svmp_midRT_nstd_residue_npool1'});
pip.pip_addstep_folder_sfx_all(tid_1D, 'FIGURE_1D_model', {sub, 'variable5', true}, ...
    {'model1D_autosfx'}, [4,1,2,3], 'outputnames', 'Extended Fig4', 'jobname', '1D model', ...
    'is_output', true);
